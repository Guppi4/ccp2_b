...
int main() {
	...
	try{
		...
		notebook.erase(/*page=*/100, /*row=*/100, /*column=*/50, Direction::Horizontal, /*length=*/4);
			// writes ~ instead of _ in line 99, b in line 100 and _ again in line 99
        cout << notebook.read(/*page=*/100, /*row=*/100, /*column=*/50, Direction::Horizontal, /*length=*/5) << endl; 
